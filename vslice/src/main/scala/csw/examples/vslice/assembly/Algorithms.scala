...
object Algorithms {
  ...
  def focusZenithAngleToElevationAndRangeDistance(calculationConfig: TromboneCalculationConfig, elevation: Double, focusError: Double, zenithAngle: Double): (Double, Double) = {
  ...
  def focusZenithAngleToRangeDistance(calculationConfig: TromboneCalculationConfig, elevation: Double, focusError: Double, zenithAngle: Double): Double = {
